...
// Definindo as default props fora do componente
Home.defaultProps = {
        ...
        <div>
            ...
            <main className={styles.container_home}>
                ...
                <section className={styles.hero_section}>
                    <div className={styles.container_slogan} id='container' data-aos="fade-down">
                ...
                {/* Promoções */}
                <section className="background">
                    <div className={styles.container_promotion} id="container" data-aos="fade-up">
                        <Banner bannerimg={imgBanner} bannerc={bannerc} bannerverde={Bannerverde} bannerjunino={Bannerjunina} />
                        <CarouselProd />
                    </div>
                </section>
                ...
                <div id="background">
                    <section className={styles.mercados} id='container'>
                        <TituloFormato categoria={t("Ja trabalham conosco")} />
                ...
                <div id="background">
                    <section className={styles.perguntas} id='container'>
                        <TituloFormato categoria={t("TituloPerguntas")} />
                        <ContainerPerguntas />
                    </section>
                </div>
            </main>
