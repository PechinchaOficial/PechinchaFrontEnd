...
import Styles from './Carrefour.module.css'
import carrefour from '../../../assets/img/Market/logocarrefour.png'
...
function Ricoy({img}) {
    ...
    return (
        ...
        <div>
            <HeaderConsumer />
            <main>
                <MarketPage banner={Styles.bannermarket} logo={Styles.carrefour} img={carrefour} adress="Bairro Ariston Estela Azevedo, 762" name="Carrefour" product="Produtos: 123" date="anuncia desde: 20/10/2024" star="Vendedor: Premium"/>
